...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_DESTROY:
		...
		//  printf( "The file 'message.txt' was not opened\n" );
		//else
		// printf( "The file 'message.txt' was opened\n" );
		stream = fopen( "message.txt", "r" );
		fread(text,1,100,stream);

		MessageBox(0,text,"warming",0);
		PostQuitMessage(0);
		break;
	default:
		return DefWindowProc(hWnd, message, wParam, lParam);
